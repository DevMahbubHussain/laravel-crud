        ...
        <section>
            <form action="{{ route('offers.store') }}" method="post" enctype="multipart/form-data">
                ...
                <div class="bg-gray-100 py-6 sm:py-12 flex justify-center align-items">
                    <div class="relative max-w-2xl mx-5 px-4 w-full py-10 bg-white md:mx-0 shadow rounded-3xl sm:p-10">
                        ...
                        <div class="divide-y divide-gray-200">
                                ...
                                <div class="flex flex-col image-preview">
                                    ...
                                    <div class="flex items-center justify-center p-4">
                                        <img class="w-96 h-72 object-cover rounded-3xl"
                                            src="{{ asset(\App\Models\Offer::PLACEHOLDER_IMAGE_PATH) }}" alt="">
                                    </div>
                            ...
                            <div class="pt-4 flex items-center space-x-4">
                                ...
                                <button
                                    class="bg-green-500 flex justify-center items-center w-ful px-4 py-3 rounded-md focus:outline-none">Create</button>
                            </div>
                        </div>
                    </div>
                </div>
