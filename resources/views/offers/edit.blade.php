                        ...
                        <div class="divide-y divide-gray-200">
                            <div class="py-8 text-base leading-6 space-y-4 text-gray-700 sm:text-lg sm:leading-7">
                                <div class="flex flex-col">
                                    <label class="leading-loose">Title <span
                                            class="text-red-400 text-sm">(required)</span></label>
                                    <input name="title" value="{{ old('title', $offer->title) }}" type="text"
                                        required="required"
                                ...
                                <div class="flex flex-col">
                                    <label class="leading-loose">Price <span
                                            class="text-red-400 text-sm">(required)</span></label>
                                    <input name="price" value="{{ old('price', $offer->price) }}" type="number"
                                ...
                                <div class="flex flex-col">
                                    <label class="leading-loose">Category<span
                                            class="text-red-400 text-sm">(required)</span></label>
                                    <select
                                        ...
                                        id="select-category" name="categories[]" multiple autocomplete="off">
                                ...
                                <div class="flex flex-col">
                                    <label class="leading-loose">Location<span
                                            class="text-red-400 text-sm">(required)</span></label>
                                    <select
                                        class="px-4 py-1 border focus:ring-gray-500 focus:border-gray-900 w-full sm:text-sm border-gray-300 rounded-md focus:outline-none text-gray-600"
                                        id="select-location" name="locations[]" multiple autocomplete="off">
                                ...
                                <div class="flex flex-col">
                                    <label class="leading-loose">Description<span
                                            class="text-red-400 text-sm">(required)</span></label>
                            ...
                            <div class="pt-4 flex items-center space-x-4">
                                ...
                                <button
                                    class="bg-green-500 flex justify-center items-center w-full text-white px-4 py-3 rounded-md focus:outline-none">Update</button>
                            </div>
                        </div>
                    </div>
                </div>
