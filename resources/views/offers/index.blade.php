    ...
    <div class="container mx-auto">
        ...
        <section class="py-8 container px-4 mx-auto">
            <div class="bg-white py-4 mb-4 rounded-xl">
                <form action="" method="GET" class="flex md:flex-row flex-col gap-8 justify-center">
                    <div class="px-8 py-2 bg-white border border-gray-200 rounded-3xl">
                        <select name="status"
                            ...
                            @foreach (\App\Constants\Status::LIST as $status)
                                <option {{ request()->query('status') === $status ? 'selected' : '' }}
                    ...
                    <div class="bg-white">
                        <input
                            ...
                            type="text" name="title" placeholder="Search by title..." value="">
                    </div>
                    <div>
                        <button type="submit"
                                ...
                                <tr class="border-b border-gray-100">
                                    <td class="p-0">
                                        <div class="flex break-words items-center pl-4">
                                            ...
                                            <span
                                                class="font-heading font-medium ml-5 inline-block">{{ $offer->author->name }}</span>
                                        </div>
                                    </td>
                                    <td class="p-0">
